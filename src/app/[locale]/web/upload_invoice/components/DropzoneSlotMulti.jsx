...
import { LuReceiptText, LuFile, LuUpload, LuCircleX } from 'react-icons/lu'
...
const ACCEPTED_TYPES = {
  ...
  const renderIcon = () => {
    ...
    if (isDragAccept) return <LuUpload   size={24} className={`animate-bounce ${cfg.iconColor}`} />
  ...
  return (
    <div
      ...
      className={`
        ...
        items-center justify-center gap-2 rounded-xl border-2 border-dashed
        text-center transition-all duration-200

        /* Altura: más pequeño en móvil, más grande en escritorio */
        h-24 md:h-28
    ...
    >
      ...
      <div className="flex flex-col gap-0.5 px-1">
        ...
        {/* Subtexto solo visible en pantallas medianas en adelante */}
